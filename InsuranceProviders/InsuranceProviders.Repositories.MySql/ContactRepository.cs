...
namespace InsuranceProviders.Repositories.MySql
{
    public class ContactRepository : IContactRepository
    {
        ...
        public async Task<IEnumerable<Contact>> GetContacts(string insuranceProviderCode)
        {
            ...
            parameters.Add("@insurance_provider_code", insuranceProviderCode);

            var query = @"SELECT 
                            ct.ContactId,
                            ct.insuranceproviderId,
                            ct.Name,
                            ct.Title,
                            ct.Location,
                            ct.CreatedDate,
                            ...
                            ct.ModifiedBy
                        FROM insurance i
            inner join Contact ct on i.insuranceproviderid = ct.insuranceproviderid
            WHERE i.insuranceproviderCode= @insurance_provider_code";
        ...
        {
            var parameters = new DynamicParameters();
            parameters.Add("@insuranceprovider_id", contact.insuranceProviderId);
            ...
            var query = @"INSERT INTO insuranceproviders_db.Contact(insuranceproviderId,Name,Title,Location,CreatedDate,CreatedBy)
                        VALUES
                        (@insuranceprovider_id,@contact_name,@contact_title,@contact_location,@created_date,@created_by);
        ...
        public async Task<int> SaveContactPhones(ContactPhones contactPhone)
        {
            ...
            parameters.Add("@insuranceprovider_id", contactPhone.insuranceProviderId);
            ...
            var query = @"INSERT INTO insuranceproviders_db.ContactPhones(ContactId,insuranceproviderId,PhoneNumber,PhoneType,CreatedDate,CreatedBy)
                        VALUES
                        (@contact_id,@insuranceprovider_id,@phone_number,@phone_type,@created_date,@created_by);";
        ...
        public async Task<int> SaveContactAddresses(ContactAddresses contactAddress)
        {
            ...
            parameters.Add("@insuranceprovider_id", contactAddress.insuranceProviderId);
            ...
            var query = @"INSERT INTO insuranceproviders_db.ContactAddresses(ContactId,insuranceproviderId,Address,AddressType,CreatedDate,CreatedBy)
                        VALUES
                        (@contact_id,@insuranceprovider_id,@address,@address_type,@created_date,@created_by);";
        ...
        public async Task<int> UpdateContact(Contact contact)
        {
            ...
            var query = @"UPDATE insuranceproviders_db.Contact
                        SET
                        insuranceproviderId = @insuranceprovider_id,
                        Name = @contact_name,
                        Title = @conact_title,
        ...
        public async Task<int> UpdateContactPhones(ContactPhones contactPhone)
        {
            ...
            var query = @"UPDATE insuranceproviders_db.ContactPhones
                        SET
                        insuranceproviderId = @insuranceprovider_id,
        ...
        public async Task<int> UpdateContactAddresses(ContactAddresses contactAddress)
        {
            ...
            var query = @"UPDATE insuranceproviders_db.ContactAddresses
                        SET
                        insuranceproviderId = @insuranceprovider_id,
                        Address = @address,
